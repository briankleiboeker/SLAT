  ...
  output$analyzed_data <- renderUI({
    ...
    if(input$comp == ""){
      ...
      tagList(
        ...
        p("Need to assign elemental compositions to m/z values after realigning m/z's? Check out ",url,"Instructions for usage, source code, and a test dataset are available at ",url2),
